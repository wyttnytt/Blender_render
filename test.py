...
class Cube():
    ...
    def create_cube(self):
        ...
        pmatrx = aDouble(x, z, y, x+width, z, y, x, z+depth, y, x+width, z+depth, y, x, z+depth, y+height, x+width, z+depth, y+height, x, z, y+height, x+width, z, y+height, x, z, y, x+width, z, y)
        return pmatrx
...
mesh1 = acad.model.Add3DMesh(5 , 2, matrx)
...
mesh2 = acad.model.Add3DMesh(5 , 2, matrx2)
...
mesh3 = acad.model.Add3DMesh(5 , 2, matrx3)
